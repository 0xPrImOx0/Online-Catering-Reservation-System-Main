          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="border rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  ...
                  seasonal fruit platters, gourmet egg dishes, and premium
                  coffee service.
                </p>
                <div className="text-sm text-muted-foreground mb-4">
                  ...
                  <p>
                    <span className="font-medium">Package:</span> Morning
                    Delight Package
                  </p>
                </div>
            ...
            <div className="border rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Sophisticated lunch menu featuring gourmet sandwiches,
                  artisanal salads, and signature soups. Perfect for corporate
                ...
                <div className="text-sm text-muted-foreground mb-4">
                  ...
                  <p>
                    <span className="font-medium">Package:</span> Corporate
                    Deluxe
                  </p>
                </div>
                <div className="flex justify-between items-center">
            ...
            <div className="border rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  ...
                  optional premium bar service. Perfect for social gatherings
            ...
            <div className="border rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="text-sm text-muted-foreground mb-4">
                  ...
                  <p>
                    <span className="font-medium">Package:</span> Wedding
                    Elegance
                  </p>
                </div>
                <div className="flex justify-between items-center">
            ...
            <div className="border rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Innovative vegan menu featuring creative plant-based dishes
                  that will impress even non-vegan guests. Includes appetizers,
                  mains, and desserts.
                </p>
                <div className="text-sm text-muted-foreground mb-4">
                  <p>
            ...
            <div className="border rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Elegant dessert display featuring miniature pastries,
                  chocolate fondue, fresh fruit, and custom cakes. Perfect
            ...
            <div className="border rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Elegant brunch featuring made-to-order omelets, waffle
                  station, carving station, and mimosa bar. Perfect for weekend
                  events.
                </p>
                <div className="text-sm text-muted-foreground mb-4">
                  <p>
            ...
            <div className="border rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Child-friendly options that are both nutritious and appealing
                  to younger guests. Includes allergy-friendly alternatives.
                </p>
                <div className="text-sm text-muted-foreground mb-4">
                  <p>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="group">
                ...
                <p className="text-sm text-muted-foreground">
                  <span className="font-medium">Featured in:</span> Gourmet
                  Dinner Service, Wedding Elegance Package
                </p>
              </div>
              ...
              <div className="group">
                ...
                <p className="text-sm text-muted-foreground">
                  <span className="font-medium">Featured in:</span> Gourmet
                  Dinner Service, Corporate Deluxe Package
                </p>
              </div>
              ...
              <div className="group">
                ...
                <p className="text-muted-foreground text-sm mb-3">
                  Fresh shrimp marinated in citrus juices with avocado,
                  cucumber, red onion, and cilantro, served in individual
                  glasses.
                </p>
                <div className="flex flex-wrap gap-2 mb-3">
                  <Badge
