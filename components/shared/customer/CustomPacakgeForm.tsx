  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      ...
      <Dialog open={showConfirmation} onOpenChange={setShowConfirmation}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Custom Package Request Sent!</DialogTitle>
            <DialogDescription>
              Thank you for your custom package request. Our caterer will call
              you within 1 hour to discuss the details and provide a quote.
            </DialogDescription>
          </DialogHeader>
